...
function LoginForm() {
  ...
  const activeError =
    ...
    (oauthError === 'google_not_configured'
      ? 'Google OAuth credentials not configured in .env (GOOGLE_CLIENT_ID & GOOGLE_CLIENT_SECRET).'
      : oauthError === 'github_not_configured'
      ? 'GitHub OAuth credentials not configured in .env (GITHUB_CLIENT_ID & GITHUB_CLIENT_SECRET).'
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-animated">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="gradient-text" style={{ fontSize: 28, fontWeight: 800, marginBottom: 6 }}>
            CloudVault
          </h1>
